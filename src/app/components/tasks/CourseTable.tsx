...
export default function CourseTable({ courses, onDelete, onAdd, onUpdate, loading = false }: CourseTableProps) {
      ...
      <div className="border-[3px] border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
        <table className="w-full">
          ...
          <tbody>
            {loading && (
              <tr>
                <td colSpan={5} className="px-4 py-8 text-center font-black text-xs uppercase text-gray-400">
                  Loading courses...
                </td>
              </tr>
            )}
                ...
                <td className="px-4 py-3 font-black text-sm text-black">
                  {editingId === course.id ? (
                    <input
                      ...
                      className="w-16 border-2 border-black px-2 py-1 font-black text-sm"
                    />
                  ) : (
                    course.sks
                  )}
