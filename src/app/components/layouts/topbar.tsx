...
const TopBar = () => {
  ...
  return (
    <nav className="w-full font-sans antialiased">
      {/* Desktop TopBar */}
      <header className="hidden md:flex w-full bg-white border-b-[4px] border-black px-6 py-0 items-stretch">
        ...
        <div className="flex-1 flex items-center max-w-lg">
          <div className="flex items-center w-full bg-[#F4F8FA] border-[3px] border-black px-4 py-2 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] focus-within:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] focus-within:translate-x-[1px] focus-within:translate-y-[1px] transition-all">
            ...
            <input
              ...
              className="bg-transparent outline-none w-full font-bold text-sm text-black placeholder:text-gray-400 tracking-wide"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 ml-6">
          <button
            ...
            className="relative p-2.5 bg-white border-[3px] border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none transition-all outline-none focus-visible:ring-2 focus-visible:ring-black"
          >
          ...
          <div className="flex items-center gap-2 px-3 py-2 bg-[#FFB3C1] border-[3px] border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] cursor-pointer hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] transition-all">
            <div className="w-7 h-7 bg-black flex items-center justify-center">
              <span className="font-black text-xs text-[#FFB3C1]">A</span>
            </div>
        ...
        <div className={`${page.color} border-b-[3px] border-black px-4 py-4`}>
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="w-9 h-9 bg-black border-[3px] border-black flex items-center justify-center shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
                <span className="font-black text-sm text-[#FFB3C1]">A</span>
              </div>
            </div>
          </div>
          {/* Mobile Search */}
